...
class EmployeeTest {
    ...
    private void setup() {
        ...
        System.out.println(project1.getCommittedHoursPerDay());
        for (Integer hours: project1.getCommittedHoursPerDay().values()) {
            System.out.println("Project 1 committed hours: " + hours);
        }
