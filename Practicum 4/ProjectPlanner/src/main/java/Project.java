...
public class Project implements Comparable<Project> {
    ...
    public String toString() {
        return String.format("%s(%s)", this.getTitle(), this.getCode());
    }
    ...
    public boolean equals(Object employee) {
        return this.getTitle().equals(((Project) employee).getTitle()) && this.getCode().equals(((Project) employee).getCode());
    }
    ...
    public void addCommitment(Employee employee, int hoursPerDay) {
        if (employee != null) {
            if (committedHoursPerDay.containsKey(employee)) {
                this.committedHoursPerDay.merge(employee, hoursPerDay, Integer::sum);
            } else {
    ...
    public int calculateManpowerBudget() {
        ...
        for (Map.Entry<Employee, Integer> employee : this.getCommittedHoursPerDay().entrySet()) {
            result += (employee.getValue() * employee.getKey().getHourlyWage());
        }
        return result * this.getNumWorkingDays();
    }
