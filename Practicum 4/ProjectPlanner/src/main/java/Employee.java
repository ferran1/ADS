...
public class Employee implements Comparable<Employee> {
    ...
    public String toString() {
        return String.format("%s(%d)", this.getName(), this.getNumber());
    }
    ...
    public boolean equals(Object employee) {
        return this.getName().equals(((Employee) employee).getName()) && this.getNumber() == ((Employee) employee).getNumber();
    }
    ...
    public int calculateManagedBudget() {
        return getManagedProjects().stream()
